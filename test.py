...
dueTime = 0
listOfMessage: list[telegram.Message] = []
...
def sendText(context: CallbackContext) -> None:
    ...
    job = context.job
    context.bot.send_message(job.context.chat_id, text=job.context.text)
...
def set_timer(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        #     alarm, due, context=update.message, name=str(chat_id)
        # )
...
def recieveText(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        context.job_queue.run_once(
            sendText, dueTime, context=update.message, name=str(chat_id)
        )
